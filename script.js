...
const loginModal = document.getElementById('loginModal'); // Diperbaiki: Sesuai dengan ID di HTML Anda
const loginUsernameInput = document.getElementById('login-username'); // Diperbaiki: Sesuai dengan ID di HTML Anda
const loginPasswordInput = document.getElementById('login-password'); // Diperbaiki: Sesuai dengan ID di HTML Anda
const loginBtn = document.getElementById('login-btn');
const loginCompanyNameDisplay = document.getElementById('login-company-name-display');

const tabButtons = document.querySelectorAll('.tab-button');
const tabContents = document.querySelectorAll('.tab-content');
const notificationArea = document.getElementById('notification-area'); // Pastikan ini ada di HTML dengan ID ini
...
function saveData() {
    ...
    // Tambahkan ini jika ingin mempertahankan sesi login saat browser ditutup
...
function handleLogin() {
    ...
    if (user) {
        currentUser = user;
        saveData(); // Simpan sesi login pengguna saat ini
