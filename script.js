...
function initializeScanner(targetVideoElement, targetOverlayElement, startButton, stopButton, mode) {
    ...
    targetOverlayElement.style.display = 'flex';
    ...
    Quagga.init({
        ...
        targetOverlayElement.style.display = 'none';
        Quagga.start();
...
// --- Event Listeners untuk Barcode Scanner di Kasir ---
...
// --- Fungsionalitas Scan Barcode untuk Kasir ---
...
// --- Event Listeners untuk Barcode Scanner di Produk (Inventaris) ---
...
// --- Fungsionalitas Scan Barcode untuk Produk (Inventaris) ---
...
// --- New Product / Update Product Logic ---
